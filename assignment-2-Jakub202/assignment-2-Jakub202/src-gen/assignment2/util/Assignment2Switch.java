...
public class Assignment2Switch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case Assignment2Package.SOLVER: {
			...
			if (result == null)
				result = caseAlgorithm(solver);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case Assignment2Package.PROBLEM_GENERATOR: {
			ProblemGenerator problemGenerator = (ProblemGenerator) theEObject;
			T result = caseProblemGenerator(problemGenerator);
			if (result == null)
				result = caseAlgorithm(problemGenerator);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case Assignment2Package.SHEETS_CONFIG: {
			SheetsConfig sheetsConfig = (SheetsConfig) theEObject;
			T result = caseSheetsConfig(sheetsConfig);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Problem Generator</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Problem Generator</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseProblemGenerator(ProblemGenerator object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Sheets Config</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Sheets Config</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSheetsConfig(SheetsConfig object) {
		return null;
	}
