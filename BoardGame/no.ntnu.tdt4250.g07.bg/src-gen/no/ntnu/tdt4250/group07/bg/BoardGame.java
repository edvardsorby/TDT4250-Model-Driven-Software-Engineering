 ...
 *   <li>{@link no.ntnu.tdt4250.group07.bg.BoardGame#getCellstates <em>Cellstates</em>}</li>
 *   <li>{@link no.ntnu.tdt4250.group07.bg.BoardGame#getWinConditions <em>Win Conditions</em>}</li>
...
public interface BoardGame extends EObject {
	 ...
	 * @see no.ntnu.tdt4250.group07.bg.BgPackage#getBoardGame_Cellstates()
	 ...
	 * @see no.ntnu.tdt4250.group07.bg.BgPackage#getBoardGame_WinConditions()
	 * @model containment="true" required="true"
	 * @generated
	 */
