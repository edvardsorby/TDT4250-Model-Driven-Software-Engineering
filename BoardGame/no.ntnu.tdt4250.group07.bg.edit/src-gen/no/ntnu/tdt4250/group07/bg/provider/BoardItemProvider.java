...
/**
 * This is the item provider adapter for a {@link no.ntnu.tdt4250.group07.bg.Board} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BoardItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						BgPackage.Literals.BOARD__NAME, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
						null, null));
	}
	...
	protected void addStartPositionPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Board_StartPosition_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Board_StartPosition_feature",
								"_UI_Board_type"),
						BgPackage.Literals.BOARD__START_POSITION, true, false, false,
	...
	protected void addCellPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Board_cell_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Board_cell_feature", "_UI_Board_type"),
						BgPackage.Literals.BOARD__CELL, true, false, true, null, null, null));
	}
	...
	protected void addBoardstatePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Board_boardstate_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Board_boardstate_feature",
								"_UI_Board_type"),
						BgPackage.Literals.BOARD__BOARDSTATE, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BgPackage.Literals.BOARD__PLAYERBRICKSET);
			childrenFeatures.add(BgPackage.Literals.BOARD__VALIDMOVE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(BgPackage.Literals.BOARD__PLAYERBRICKSET,
				BgFactory.eINSTANCE.createPlayerBrickSet()));

		newChildDescriptors
				.add(createChildParameter(BgPackage.Literals.BOARD__VALIDMOVE, BgFactory.eINSTANCE.createValidMove()));
	}
