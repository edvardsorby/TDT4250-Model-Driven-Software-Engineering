...
public class BrickChangeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_BrickChange_Name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_BrickChange_Name_feature",
								"_UI_BrickChange_type"),
						BgPackage.Literals.BRICK_CHANGE__NAME, true, false, false,
	...
	public String getText(Object object) {
		String label = ((BrickChange) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_BrickChange_type")
				: getString("_UI_BrickChange_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BrickChange.class)) {
