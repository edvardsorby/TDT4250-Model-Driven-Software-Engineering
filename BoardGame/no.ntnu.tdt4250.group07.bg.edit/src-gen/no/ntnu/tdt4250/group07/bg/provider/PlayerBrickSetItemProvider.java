...
public class PlayerBrickSetItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BgPackage.Literals.PLAYER_BRICK_SET__BRICK);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(BgPackage.Literals.PLAYER_BRICK_SET__BRICK, BgFactory.eINSTANCE.createBrick()));
	}
