...
/**
 * This is the item provider adapter for a {@link no.ntnu.tdt4250.group07.bg.Rules} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RulesItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addBoardPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Rules_board_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Rules_board_feature", "_UI_Rules_type"),
						BgPackage.Literals.RULES__BOARD, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BgPackage.Literals.RULES__BOARD);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(BgPackage.Literals.RULES__BOARD, BgFactory.eINSTANCE.createBoard()));
	}
