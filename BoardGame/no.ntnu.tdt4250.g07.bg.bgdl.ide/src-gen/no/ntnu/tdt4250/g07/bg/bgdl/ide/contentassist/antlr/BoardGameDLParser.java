...
public class BoardGameDLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, BoardGameDLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getPieceTypeAccess().getGroup_9_3(), "rule__PieceType__Group_9_3__0");
			...
			builder.put(grammarAccess.getValidMoveAccess().getGroup_3_2(), "rule__ValidMove__Group_3_2__0");
			...
			builder.put(grammarAccess.getPieceTypeAccess().getSymbolAssignment_3(), "rule__PieceType__SymbolAssignment_3");
			...
			builder.put(grammarAccess.getPieceTypeAccess().getEffectsoncellAssignment_9_2(), "rule__PieceType__EffectsoncellAssignment_9_2");
			builder.put(grammarAccess.getPieceTypeAccess().getEffectsoncellAssignment_9_3_1(), "rule__PieceType__EffectsoncellAssignment_9_3_1");
			...
			builder.put(grammarAccess.getValidMoveAccess().getPlaceAnywhereAssignment_2(), "rule__ValidMove__PlaceAnywhereAssignment_2");
			builder.put(grammarAccess.getValidMoveAccess().getConditionsAssignment_3_1(), "rule__ValidMove__ConditionsAssignment_3_1");
			builder.put(grammarAccess.getValidMoveAccess().getConditionsAssignment_3_2_1(), "rule__ValidMove__ConditionsAssignment_3_2_1");
			builder.put(grammarAccess.getEffectOnCellAccess().getXAssignment_5(), "rule__EffectOnCell__XAssignment_5");
			builder.put(grammarAccess.getEffectOnCellAccess().getYAssignment_7(), "rule__EffectOnCell__YAssignment_7");
			builder.put(grammarAccess.getEffectOnCellAccess().getCellstateAssignment_11(), "rule__EffectOnCell__CellstateAssignment_11");
			builder.put(grammarAccess.getConditionAccess().getCellstateAssignment_2(), "rule__Condition__CellstateAssignment_2");
			builder.put(grammarAccess.getInARowAccess().getHorizontalAssignment_0(), "rule__InARow__HorizontalAssignment_0");
			builder.put(grammarAccess.getInARowAccess().getVerticalAssignment_1(), "rule__InARow__VerticalAssignment_1");
			builder.put(grammarAccess.getInARowAccess().getDiagonalAssignment_2(), "rule__InARow__DiagonalAssignment_2");
			builder.put(grammarAccess.getInARowAccess().getCountAssignment_4(), "rule__InARow__CountAssignment_4");
		}
	}
